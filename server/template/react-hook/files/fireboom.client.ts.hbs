...
import type { RequestOptions, UserListener, Response } from "fireboom-wundersdk";
...
export const FIREBOOM_S3_ENABLED = {{hasS3Provider}};
export const FIREBOOM_AUTH_ENABLED = {{hasAuthProviders}};
